...
CREATE TABLE PERSONA_AUTORIZADA (ID BIGINT NOT NULL, FECHAFIN DATE, FECHAINICIO DATE, APELLIDOS VARCHAR NOT NULL, CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL INTEGER NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR, FECHA_NACIMIENTO DATE, NOMBRE VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, US_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE USUARIO (USUARIO VARCHAR NOT NULL, CORREO VARCHAR, ESADMINISTRATIVO BOOLEAN NOT NULL, PASSWORD VARCHAR, SALT VARCHAR, PRIMARY KEY (USUARIO))
