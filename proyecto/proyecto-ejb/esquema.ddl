...
CREATE TABLE PERSONA_AUTORIZADA (ID BIGINT NOT NULL, FECHAFIN DATE, FECHAINICIO DATE, APELLIDOS VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR, FECHA_NACIMEINTEO DATE, NOMBRE VARCHAR NOT NULL, US_USUARIO VARCHAR, PRIMARY KEY (ID))
