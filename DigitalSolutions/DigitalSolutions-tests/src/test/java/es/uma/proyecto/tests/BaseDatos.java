...
public class BaseDatos {
	...
	public static void inicializaBaseDatos(String nombreUnidadPersistencia, Map<String,String> properties) {
		...
		emp2.setIdentificacion("otroStringAntiBug");
		emp2.setId(2L);
		emp2.setTipo_cliente("juridica");
		emp2.setEstado("activa");
		emp2.setFecha_alta(new Date());
		emp2.setDireccion("direccion");
		emp2.setCiudad("granada");
		emp2.setCodigoPostal(29000);
		emp2.setPais("España");
		emp2.setRazon_social("trabajador");
		em.persist(emp2);
			
		Autorizacion au2 = new Autorizacion();
		Autorizacion_PK aupk2 = new Autorizacion_PK();
		aupk2.setEmID(emp2.getId());
